...
bamfile1= 'LN.bam';  
cc1 = countReadsBAM(bamfile1, refgenome = "mm9");  # counts the number of cuts in the sequence file.
cc1
cutcountfile1 = makeCutCountBAM(bamfile1, refgenome = "mm10");   # generate a BedGraph file with ATAC Cleavages counts

bamfile2= 'DM.bam';
cc2 = countReadsBAM(bamfile2, refgenome = "mm9");  
cc2
...
gfootoption_fed_fasted <- GFootOption(biasfile = "/Hexamer_all_mm10_withoutMap.txt",   # Hexamer bias frequency table (see "bigfoot_prep_example.R")
...
GFoot_fed_fasted= GFoot(control = LN,    ##  Control Data defined above
...
GFoot_fed_fasted <- run(GFoot_fed_fasted, graphout=T,yrange=c(-2.5,1.5), mc.cores = 24 ) 
